...
public class SeleniumTestParameters extends TestParameters {
	...
	private String alexaTestApproach;
	private String voiceNameForAlexa;
    ...
    */
	...
	public String getAlexaTestApproach() {
		return alexaTestApproach;
	}

	public void setAlexaTestApproach(String alexaTestApproach) {
		this.alexaTestApproach = alexaTestApproach;
	}

	public String getVoiceNameForAlexa() {
		return voiceNameForAlexa;
	}

	public void setVoiceNameForAlexa(String voiceNameForAlexa) {
		this.voiceNameForAlexa = voiceNameForAlexa;
	}
